...
export const googleSignIn = (auth, provider, callback) => signInWithPopup(auth, provider)
  .then((result) => {
...
export const getRedirect = (auth) => getRedirectResult(auth)
  .then((result) => {
...
export const onAuthChange = (auth) => onAuthStateChanged(auth, (user) => {
    if (user) {
